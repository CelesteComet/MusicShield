...
export const basicPhongMaterial = new THREE.MeshLambertMaterial({
  color: 0xffffff
});
...
export const normalOrangeMaterial = new THREE.MeshLambertMaterial({
  color: 0xEC4C29
});

export const normalBlueMaterial = new THREE.MeshLambertMaterial({
  color: 0x4B84EC
});